...
public class TicketGenerator {
    ...
    public static BufferedImage generateTicket(String ticketNo, int nIngressi, String dataEmissione, String ticketType, String entityName) throws Exception {
        ...
        g2d.drawString(ticketType, 210, 95);
        g2d.setFont(new Font("Monospaced", Font.PLAIN, 16));
        g2d.drawString("Ingressi # " + nIngressi, 210, 115);
        g2d.drawString(dataEmissione, 210, 135);
    ...
    public static BufferedImage generateMultipleTickets(String ticketNo, int nIngressi, String dataEmissione, String ticketType, String entityName) throws Exception {
        ...
        for(int i=0; i< nIngressi; i++) {
            BufferedImage singleTicket = generateTicket(ticketNo, 1, dataEmissione, ticketType, entityName);
